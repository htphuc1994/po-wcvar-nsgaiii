...
def my_solve():
    ...
    # below is for other algorithms ------ TODO
    front_0 = sorted(
...
# Todo: experiments: https://docs.google.com/spreadsheets/d/1TO8SQUXlpY7_vTl0qgQDGRrOSoGw1tWYO8i703o3P40/edit?gid=157556016#gid=157556016
