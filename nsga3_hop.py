...
class NSGA3(GeneticAlgorithm):
    ...
    def __init__(self,
                 ...
                 selection=TournamentSelection(func_comp=comp_by_cv_then_random, pressure=10),
...
def hop(pop, indices):
    ...
    profit_threshold = -constants.INITIAL_CASH * (1 + constants.BANK_INTEREST_RATE_AFTER_N_INVESTMENT_PERIOD)
